...
static const test_data_t test_data[] = {
  //{1, (int64_t[1]){ 13},  5, (int64_t[1]){ 2},  3},//0
  {1, (int64_t[1]){-666},  1, (int64_t[1]){-666}, 0},//1
  {1, (int64_t[1]){ -503}, 1, (int64_t[1]){-503},  0},//2
  //{1, (int64_t[1]){-13}, -5, (int64_t[1]){ 2}, -3},//3
  //{2, (int64_t[2]){0,  13},  5, (int64_t[2]){0x9999999999999999,  2},  3},//4
//  {2, (int64_t[2]){0, -13},  5, (int64_t[2]){0x6666666666666667, -3}, -3},//5
  //{2, (int64_t[2]){0,  13}, -5, (int64_t[2]){0x6666666666666667, -3},  3},//6
  //{2, (int64_t[2]){0, -13}, -5, (int64_t[2]){0x9999999999999999,  2}, -3},//7
  //{3, (int64_t[3]){1, 1, 1}, 2, (int64_t[3]){0x8000000000000000, 0x8000000000000000, 0},  1},//8
//{2, (int64_t[2]){ 0, 0x8000000000000000},  -1, (int64_t[2]){ 0, 0x8000000000000000},  0},
