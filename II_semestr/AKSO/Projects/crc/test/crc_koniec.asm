...
.poly_crc_written:
   ...
   ; Otwarcie powiodło się tworzymy rejestr trzymający,
   ; zapalony bit na pozycji crc_poly_len-1 licząc od najmniej,
   ; znacząscych bitów. Liczba ta będzie trzymana w r12.
