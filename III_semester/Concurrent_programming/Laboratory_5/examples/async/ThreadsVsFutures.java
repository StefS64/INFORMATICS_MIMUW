...
import lab05.examples.async.HomemadeFuture.Future;
import lab05.examples.async.HomemadeFuture.ThreadPool;
import lab05.examples.async.Utils.Stopwatch;
        ...
        stopwatch.runWithStopwatch(() -> {
            for (int i = 0; i < WORK_SIZE; i++) {
                Future<Object> future = pool.submit(() -> {
                    ...
                    return new Object(); // Needed because our version of Future *must* return something.
                });
                futures.add(future);
            }
