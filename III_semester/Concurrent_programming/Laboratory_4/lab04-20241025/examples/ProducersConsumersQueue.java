...
public class ProducersConsumersQueue {
    ...
    private static final BlockingQueue<Product> queue = new LinkedBlockingQueue<>(BUFFER_SIZE);
    ...
    public static void main(String[] args) {
        ...
        assert Arrays.stream(PRODUCER_COUNTS).sum() * PRODUCED_COUNT == CONSUMERS_COUNT * CONSUMED_COUNT;
